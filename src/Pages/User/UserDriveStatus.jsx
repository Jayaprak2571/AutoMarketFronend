...
const api = axios.create({
  baseURL: "https://jayapraky.pythonanywhere.com",
});

const MyVehiclesStatus = () => {
  ...
  useEffect(() => {
    ...
    api
      .get(`/testdrive/getdrivestatus/${userId}`, {
...
export default MyVehiclesStatus;